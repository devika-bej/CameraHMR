...
class HandOptimizer:
    ...
    def refine(
        ...
        lh_pca_proj = torch.matmul(lh_full - self.model.left_hand_mean, self.model.left_hand_components.T)
        rh_pca_proj = torch.matmul(rh_full - self.model.right_hand_mean, self.model.right_hand_components.T)
